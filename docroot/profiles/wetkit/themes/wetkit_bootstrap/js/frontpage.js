  ...
  Drupal.behaviors.frontpage = {
    attach: function()
    {
      ...
      jQuery('#webform-uuid-3e910914-01b0-4ad1-8d70-7f6116c073d7').submit(function(event) {
        ...
        if (jQuery('input[id=edit-submitted-degree-type-1]:checked',
             '#webform-uuid-3e910914-01b0-4ad1-8d70-7f6116c073d7').val() === 'undergraduate') {
        ...
        } else if (jQuery('input[id=edit-submitted-degree-type-2]:checked',
              '#webform-uuid-3e910914-01b0-4ad1-8d70-7f6116c073d7').val() === 'graduate') {
        ...
        } else if (jQuery('input[id=edit-submitted-degree-type-3]:checked',
              '#webform-uuid-3e910914-01b0-4ad1-8d70-7f6116c073d7').val() === 'online') {
