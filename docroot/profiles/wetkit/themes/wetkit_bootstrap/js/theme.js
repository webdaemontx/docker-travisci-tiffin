...
jQuery( 'ul[role= "menubar"] li.dropdown a' ).css( 'cursor', 'pointer' ).removeClass( 'item' );
...
function cleanMenu () {
  ...
  jQuery( 'ul[role= "menubar"] li:nth-of-type(2)' ).addClass( 'no-sect' );
  jQuery( 'ul[role= "menubar"] li:nth-of-type(2)' ).html( '<a class="mb-item" role="menuitem" aria-setsize="6" aria-posinset="3" tabindex="-1" href="/admissions">Admissions</a>' );

  jQuery( 'ul[role= "menubar"] li:nth-of-type(4)' ).addClass( 'no-sect' );
  jQuery( 'ul[role= "menubar"] li:nth-of-type(4)' ).html( '<a class="mb-item" role="menuitem" aria-setsize="6" aria-posinset="3" tabindex="-1" href="/about">About</a>' );

  jQuery( 'ul[role= "menubar"] li:nth-of-type(5)' ).addClass( 'no-sect' );
  jQuery( 'ul[role= "menubar"] li:nth-of-type(5)' ).html( '<a class="mb-item" role="menuitem" aria-setsize="6" aria-posinset="3" tabindex="-1" href="/campuslife">Life At TU</a>' );
}
...
jQuery( document ).ready( function () {
  ...
  console.log("just cleaned the menu");
} );
*/
