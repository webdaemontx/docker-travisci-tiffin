 ...
 *
 * The preprocess_css and preprocess_js, as well as a number of other variable
 * settings that are enabled on production, need to be turned off on a local
 * developer's machine.
 *
 * For more information about these configuration settings and options, see
 * https://www.drupal.org/node/1525472.
 *
 * Not recommended in production environments.
 */
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_tiffin_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_tiffin_dev_default.inc';
}
// </DDSETTINGS>
...
// Note that SITE_NAME and DATABASE_NAME should be replaced accordingly in the following code:
...
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  switch ($_ENV['AH_SITE_ENVIRONMENT']) {
    case 'dev':
      ...
      $conf['block_cache'] = 0;
      $conf['cache'] = 0;
      $conf['site_name'] = 'Acquia TU Dev Site';
      $conf['anonymous'] = 'Dev Visitor';
